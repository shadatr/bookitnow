...
const Page = () => {
  ...
  return (
    <div className="w-screen flex justify-center items-center flex-col py-20">
        ...
        <div className=" grid grid-cols-3 w-full gap-10">
          {places.map((item) => (
            <motion.div
              ...
              className={`transtion-bg flex flex-col justify-center items-center gap-3 p-16 border rounded-xl hover:cursor-pointer hover:bg-lightGray ${
                place == item.name && "border-primary border-2 bg-lightGray"
              }`}
      ...
      <div className="w-[750px] flex flex-col justify-center">
        ...
        <div className="flex items-center justify-between p-4 text-md">
          ...
          <span className="flex items-center gap-2">
            <CiCircleMinus
              className="hover:cursor-pointer"
              onClick={() =>
                bathroomNumber != 1 && setBathroomNumber(bathroomNumber - 1)
              }
              size={40}
            />
            <p>{bathroomNumber}</p>
        ...
        <div className=" grid grid-cols-3 w-full gap-10">
          {placeStandoutAmenities.map((item) => (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className={`transtion-bg flex flex-col justify-center items-center gap-3 p-16 border rounded-xl hover:cursor-pointer hover:bg-lightGray ${
                PlaceStandoutAmenities.find((i) => i == item.name) &&
                "border-primary border-2 bg-lightGray"
              }`}
              onClick={() =>
                PlaceStandoutAmenities.find((i) => i == item.name)
        ...
        <div className=" grid grid-cols-3 w-full gap-10">
          {SafetyItems.map((item) => (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className={`transtion-bg flex flex-col justify-center items-center gap-3 p-16 border rounded-xl hover:cursor-pointer hover:bg-lightGray ${
                safetyItems.find((i) => i == item.name) &&
                "border-primary border-2 bg-lightGray"
              }`}
              onClick={() =>
                safetyItems.find((i) => i == item.name)
